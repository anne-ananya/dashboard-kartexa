...
import ClickableRectangle from './components/ClickableRectangle';
...
const App = () => {
  ...
  <div style={{
    ...
    borderRadius: '5px',
        ...
        {/* Company logo */}
        <img src="images\Frame 1000003850.png" alt="Company Logo" style={{ width: '150px' }} />
...
<button onClick={handleLogout} style={{
  ...
  <svg width="14" height="12" viewBox="0 0 14 12" fill="#0478FF" xmlns="http://www.w3.org/2000/svg" style={{ marginRight: '5px' }}>
...
<div style={{ position: 'relative' }}>
    ...
    >
      ...
      />
        ...
        <div style={{
          ...
          <img
    src="images/Ellipse 1111.png" // Update the image path here
    alt="Profile Image"
    style={{
      width: '100%',
      height: '100%',
  ...
  />
    ...
    {showMenu && <Menu handleMenuItemClick={handleMenuItemClick} />}
    <div>
    <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '125px', marginLeft: '100px', marginRight: '100px', marginBottom: '10px' }}>
  <ClickableRectangle clickable={true} imageSrc="images/Rectangle.svg" text1="20" text2="Total Leaves" style={{ width: '400px' }} />
  <div style={{ width: '10px' }}></div>
  <ClickableRectangle clickable={true} imageSrc="images/Rectangle (2).png" text1="20%" text2="Success Ratio" style={{ width: '400px' }} />
  <div style={{ width: '10px' }}></div>
  <ClickableRectangle clickable={true} imageSrc="images/Rectangle (3).png" text2="Learning Tutorials" style={{ width: '400px' }} />
</div>
<div style={{ display: 'flex', justifyContent: 'space-between', marginLeft: '100px', marginRight: '100px', marginBottom: '10px' }}>
  <ClickableRectangle clickable={true} imageSrc="images/Rectangle (4).png" text1="3" text2="Total Task" style={{ width: '400px' }} />
  <div style={{ width: '10px' }}></div>
  <ClickableRectangle clickable={true} imageSrc="images/Rectangle (5).png" text1="1" text2="Total Meet" style={{ width: '400px' }} />
  <div style={{ width: '10px' }}></div>
  <ClickableRectangle clickable={true} imageSrc="images/Rectangle (1).png" text1="3" text2="Total Badges" style={{ width: '400px' }} />
</div>
