...
const ClickableRectangle = ({ clickable, imageSrc, text1, text2 }) => {
  ...
  return (
    <div
      style={{
        width: '400px', // Adjusted width to occupy 33.33% of the container with reduced spacing
        height: '200px',
        background: 'linear-gradient(100.23deg, #ABD0FF -15.07%, #80FFC5 249.35%)',
        borderRadius: '15px',
        cursor: clickable ? 'pointer' : 'auto',
        position: 'relative',
        marginLeft: '20px', // Gap between rectangles
        marginRight: '20px', // Gap between rectangles
